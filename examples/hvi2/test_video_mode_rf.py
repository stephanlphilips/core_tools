...
from keysight_fpga.sd1.fpga_utils import print_fpga_info, print_fpga_log
...
## create sequencer
gate1, swing1, n_pt1 = 'AWG3_1', 500, 200
gate2, swing2, n_pt2 = 'AWG3_2', 500, 200
t_step = t_measure

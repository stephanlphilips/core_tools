...
def load_HVI(AWGs, channel_map, *args,**kwargs):
	...
	error1 = HVI.assignHardwareWithUserNameAndSlot("Module 0",1,2)
	error2 = HVI.assignHardwareWithUserNameAndSlot("Module 1",1,3)
	error3 = HVI.assignHardwareWithUserNameAndSlot("Module 2",1,4)
	error4 = HVI.assignHardwareWithUserNameAndSlot("Module 3",1,5)
	error5 = HVI.assignHardwareWithUserNameAndSlot("Module 4",1,6)

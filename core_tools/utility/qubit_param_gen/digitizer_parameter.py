...
def get_digitizer_qubit_param(digitizer, measurement_mgr):
    ...
    def starting_lambda():
            ...
            digitizer.set_digitizer_HVI(measurement_mgr.t_meas, measurement_mgr.n_rep*measurement_mgr.n_readouts, data_mode = DATA_MODE.AVERAGE_TIME, channels = [1,2,3,4], Vmax=0.5)
